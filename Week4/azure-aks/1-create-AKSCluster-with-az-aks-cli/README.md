...
- Design an AKS cluster using command line
- az aks cli
...
# Replace with your AD Domain - aksadmin1@innovativearchitects.com
# If you don't have permissions to do this try to associate someone already existing who you trust
AKS_AD_AKSADMIN1_USER_OBJECT_ID=$(az ad user create \
  --display-name "AKS Admin1" \
  --user-principal-name aksadmin1@innovativearchitects.com \
  --password @AKSDemo123 \
...
Username: aksadmin1@innovativearchitects.com
Password: @AKSDemo123
```
...
# Set SSH KEY Path
AKS_SSH_KEY_LOCATION=/home/ssoutrs/.ssh/aks-prod-sshkeys/aksprodsshkey.pub
